...
if [ $? = 0 ] ; then
	...
	echo -e "Software has been installed [\033[;32mFaile\033[;m."
fi
...
cd $HOME && curl -fsSL https://raw.githubusercontent.com/robbyrussell/oh-my-zsh/master/tools/install.sh > /dev/null 2>&1 && cd -
